        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {skills.map(skill => (
            <div
              ...
              className="bg-white rounded-xl border border-gray-200 p-5 cursor-pointer hover:border-gray-300 hover:bg-gray-50/50 transition-all"
            >
